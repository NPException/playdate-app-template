...
function playdate.leftButtonDown()	turn = turn - 1; player:turn(turn)	end
function playdate.leftButtonUp()	turn = turn + 1; player:turn(turn)	end
function playdate.rightButtonDown()	turn = turn + 1; player:turn(turn)	end
function playdate.rightButtonUp()	turn = turn - 1; player:turn(turn)	end
